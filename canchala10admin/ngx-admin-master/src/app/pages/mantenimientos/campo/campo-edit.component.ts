...
export class CampoEditComponent implements OnInit {
  ...
  saveSede(){
    let campoEdit = new Campo(this.campo.id, this.campo.descripcion, this.campo.implementos,this.campo.estacionamiento,this.campo.cantidad_jugadores,this.campo.vestidores,this.campo.snack, this.campo.imagen,this.campo.id_sede, this.campo.estado);
